...
function processFresnelSelectors(subj, obj) {
        ...
        var classstyles = document.meta.query2({
            ...
            where: [{
                ...
                pattern: [s, "http://argot-hub.googlecode.com/action", "?action"],
                optional: true
            }, {
                pattern: [s, "http://argot-hub.googlecode.com/yowl", "?yowl"],
                optional: true
            }, {
                pattern: [s, "http://argot-hub.googlecode.com/notify", "?notify"],
                optional: true
            }, {
                where: [{
                    pattern: [s, "http://argot-hub.googlecode.com/tooltip", "?tt"]
                }, {
                    pattern: ["?tt", "http://argot-hub.googlecode.com/icon", "?icon"],
                    optional: true
                }, {
                ...
                where: [{
                    ...
                    pattern: [s, "http://argot-hub.googlecode.com/afterpipesdata", "?afterpipesdata"],
                    optional: true
                }],
                optional: true
            }]
        ...
        classstyles = document.meta.query2({
            ...
            where: [{
                ...
                where: [{
                    ...
                    pattern: ["?embed", "http://argot-hub.googlecode.com/init", "?embedInit"],
                    optional: true
                }],
                optional: true
            }, {
                    ...
                    if (typeof classobj.q.content === "string") {
                        try {
                            q = classobj.q.content.replace(
                                /\$(?:\{|\%7B)(.*?)(?:\}|\%7D)/g,
                                function(m) {
                                    return getPropertyFromVar(obj, m);
                                }
                            );
                        } catch (e) {}
        ...
        if (format.pipesdata) {
            ...
            var requestId = document.submissionJSON.run(
                ...
                function(data, userData) {
                    if (format.adddata) {
                        execFuncWithObj(format.adddata.content, {
                            data: data,
                            obj: userData
                        }, "adddata");
            ...
            if (format.embedTemplate) {
                ...
                try {
                    t = format.embedTemplate.content.replace(
                        /\$(?:\{|\%7B)(.*?)(?:\}|\%7D)/g,
                        function(m) {
                            return getPropertyFromVar(obj, m, true);
                        }
                    );
                } catch (e) {
                    t = "error: " + e.description;
                ...
                if (format.embedInit) {
                    execFuncWithObj(format.embedInit.content, {
                        data: context,
                        obj: obj
                    }, "embedInit");
                }
...
function initialiseFresnelFormats(parser) {
    ...
    if (r && r.results.bindings[0] && r.results.bindings[0]["css"]) {
        loader.addModule({
            name: "fresnel-css-stylesheet",
            type: "css",
            fullpath: r.results.bindings[0]["css"]
        });
    ...
    document.meta.walk2(
        r, {
            action: function(obj) {
                    try {
                        (typeof obj.init.content === "function") ? obj.init.content.call(null): eval(false || obj.init.content);
                    } catch (e) {
